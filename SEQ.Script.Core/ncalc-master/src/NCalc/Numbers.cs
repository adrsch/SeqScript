...
namespace Calcc
{
    public class Numbers
    {
        ...
        static  int GetIntValFromBool(object a)
        {
            var asb = (Boolean)a;
            if (asb) return 1;
            else
        ...
        public static object Add(object a, object b, CultureInfo cultureInfo)
        {
            ...
            switch (typeCodeA)
            {
                case TypeCode.Boolean:
                    var val = GetIntValFromBool(a);
                    switch (typeCodeB)
                    {
                        case TypeCode.Boolean: return val + GetIntValFromBool(b);
                        case TypeCode.Byte:return  val + (Byte)b;
                        case TypeCode.SByte: return val + (SByte)b;
                        case TypeCode.Int16: return val  + (Int16)b;
                        case TypeCode.UInt16: return val + (UInt16)b;
                        case TypeCode.Int32: return val + (Int32)b;
                        case TypeCode.UInt32: return val + (UInt32)b;
                        case TypeCode.Int64: return val + (Int64)b;
                        case TypeCode.UInt64: throw new InvalidOperationException($"Operator '+' not implemented for 'bool' and {typeCodeB}");
                        case TypeCode.Single: return val + (Single)b;
                        case TypeCode.Double: return val + (Double)b;
                        case TypeCode.Decimal: return val + (Decimal)b;
                        default: throw new InvalidOperationException($"Operator '+' not implemented for 'bool' and {typeCodeB}");
                    }
                ...
                case TypeCode.Byte:
                    switch (typeCodeB)
                    {
                        case TypeCode.Boolean: return (Byte)a + GetIntValFromBool(b);
                ...
                case TypeCode.SByte:
                    switch (typeCodeB)
                    {
                        case TypeCode.Boolean: return (SByte)a + GetIntValFromBool(b);
                ...
                case TypeCode.Int16:
                    switch (typeCodeB)
                    {
                        case TypeCode.Boolean: return (Int16)a + GetIntValFromBool(b);
                ...
                case TypeCode.UInt16:
                    switch (typeCodeB)
                    {
                        case TypeCode.Boolean: return (UInt16)a + GetIntValFromBool(b);
                ...
                case TypeCode.Int32:
                    switch (typeCodeB)
                    {
                        case TypeCode.Boolean: return (Int32)a + GetIntValFromBool(b);
                ...
                case TypeCode.UInt32:
                    switch (typeCodeB)
                    {
                        case TypeCode.Boolean: return (UInt32)a + GetIntValFromBool(b);
                ...
                case TypeCode.Int64:
                    switch (typeCodeB)
                    {
                        case TypeCode.Boolean: return (Int64)a + GetIntValFromBool(b);
                ...
                case TypeCode.Single:
                    switch (typeCodeB)
                    {
                        case TypeCode.Boolean: return (Single)a + GetIntValFromBool(b);
                ...
                case TypeCode.Double:
                    switch (typeCodeB)
                    {
                        case TypeCode.Boolean: return (Double)a + GetIntValFromBool(b);
                ...
                case TypeCode.Decimal:
                    switch (typeCodeB)
                    {
                        case TypeCode.Boolean: return (Decimal)a + GetIntValFromBool(b);
